...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'flixger-admin-accounts': RouteRecordInfo<'flixger-admin-accounts', '/flixger/admin/accounts', Record<never, never>, Record<never, never>>,
    'flixger-admin-dashboard': RouteRecordInfo<'flixger-admin-dashboard', '/flixger/admin/dashboard', Record<never, never>, Record<never, never>>,
    'flixger-admin-orders': RouteRecordInfo<'flixger-admin-orders', '/flixger/admin/orders', Record<never, never>, Record<never, never>>,
    'flixger-admin-platforms': RouteRecordInfo<'flixger-admin-platforms', '/flixger/admin/platforms', Record<never, never>, Record<never, never>>,
    'flixger-admin-profiles': RouteRecordInfo<'flixger-admin-profiles', '/flixger/admin/profiles', Record<never, never>, Record<never, never>>,
    'flixger-catalog': RouteRecordInfo<'flixger-catalog', '/flixger/catalog', Record<never, never>, Record<never, never>>,
    'flixger-client-dashboard': RouteRecordInfo<'flixger-client-dashboard', '/flixger/client/dashboard', Record<never, never>, Record<never, never>>,
    'flixger-client-orders': RouteRecordInfo<'flixger-client-orders', '/flixger/client/orders', Record<never, never>, Record<never, never>>,
    'flixger-client-orders-id': RouteRecordInfo<'flixger-client-orders-id', '/flixger/client/orders/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'flixger-order': RouteRecordInfo<'flixger-order', '/flixger/order', Record<never, never>, Record<never, never>>,
